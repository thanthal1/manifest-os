...
static EN: &[(&str, &str)] = &[
    ...
    ("disk.layout_summary", "<b>Manifest OS:</b> {mos} GiB   ·   the existing partition keeps {keep} GiB"),
    ("disk.layout_summary_erase", "<b>Manifest OS:</b> whole disk — {total} GiB (everything on it is erased)"),
